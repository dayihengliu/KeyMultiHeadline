...
class TopicSummarizerEnConcat2Mem(BaseModel):
    """
    ...
    def __init__(self, bert_config, batcher, hps):
        super(TopicSummarizerEnConcat2Mem, self).__init__(hps, bert_config, batcher)
    ...
    def _add_placeholders(self):
        ...
        self.enc_output = tf.placeholder(tf.float32, [None, None, self.hps.hidden_size + self.hps.topic_embedding_size], name='enc_output')
    ...
    def _make_input_key(self):
        ...
        self.input_keys_infer = ['source_ids', 'topic_words_ids', 'mem_segment_ids', 'topic_ids', 'source_ids_oo', 'source_len', 'source_seg_ids', 'max_oov_num', 'encoder_output', 'topic_word_memory']
        self.input_keys = ['source_ids', 'topic_words_ids', 'source_ids_oo', 'mem_segment_ids', 'topic_ids', 'source_len', 'source_seg_ids', 'max_oov_num',
