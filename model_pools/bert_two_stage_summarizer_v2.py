...
class BertTwoStageSummarizerV2(BaseModel):
    """
    BertSummarizer + TwoStageDecoder, V2, use same decoder parameters.
    """

    def __init__(self, bert_config, batcher, hps):
        super(BertTwoStageSummarizerV2, self).__init__(hps, bert_config, batcher)
