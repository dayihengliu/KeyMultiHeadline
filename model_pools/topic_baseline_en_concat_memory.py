...
class TopicSummarizerEnConcatMem(BaseModel):
    """
    ...
    def __init__(self, bert_config, batcher, hps):
        super(TopicSummarizerEnConcatMem, self).__init__(hps, bert_config, batcher)
    ...
    def _make_input_key(self):
        ...
        self.input_keys_infer = ['source_ids', 'topic_words_ids', 'topic_ids', 'source_ids_oo', 'source_len', 'source_seg_ids', 'max_oov_num', 'encoder_output', 'topic_word_memory']
        self.input_keys = ['source_ids', 'topic_words_ids', 'source_ids_oo', 'topic_ids', 'source_len', 'source_seg_ids', 'max_oov_num',
