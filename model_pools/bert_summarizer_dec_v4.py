...
class BertSummarizerDecV4(BaseModel):
    """
    Based on BertSummarizerDecV3.
    After mask, do not multiply mask matrix, & change inference(mask each sentence and predict)
    """

    def __init__(self, bert_config, batcher, hps):
        super(BertSummarizerDecV4, self).__init__(hps, bert_config, batcher)
