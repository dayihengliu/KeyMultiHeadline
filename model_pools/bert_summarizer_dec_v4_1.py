...
class BertSummarizerDecV4V1(BaseModel):
    """
    Based on BertSummarizerDecV4.
    do not share transformer parameters on decoder.
    """

    def __init__(self, bert_config, batcher, hps):
        super(BertSummarizerDecV4V1, self).__init__(hps, bert_config, batcher)
