...
class BertSummarizerDecV3(BaseModel):
    """
    Based on BertSummarizerDecV2.
    Only mask 10% words during experiments.
    """

    def __init__(self, bert_config, batcher, hps):
        super(BertSummarizerDecV3, self).__init__(hps, bert_config, batcher)
