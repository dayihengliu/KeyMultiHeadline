...
class BertSentenceSummarizerCopyV2(BaseModel):
    """
    Based on BertSentenceSummarizer.
    Add copy mechanism v2 version.
    """

    def __init__(self, bert_config, batcher, hps):
        super(BertSentenceSummarizerCopyV2, self).__init__(hps, bert_config, batcher)
    ...
    def _make_input_key(self):
        ...
        self.input_keys_infer_1 = ['source_ids', 'source_ids_oo', 'source_len', 'source_seg_ids', 'max_oov_num',
                                   'encoder_output']
        ...
        self.input_keys = ['source_ids', 'source_ids_oo', 'source_len', 'source_seg_ids', 'max_oov_num', 'target_ids',
                           'target_len', 'sent_level_attn_bias', 'target_ids_oo']
