...
class BertSummarizerDec(BaseModel):
    """
    Based on BertSentenceSummarizerCopyRL.
    Add BERT in the second decoder.
    """

    def __init__(self, bert_config, batcher, hps):
        super(BertSummarizerDec, self).__init__(hps, bert_config, batcher)
