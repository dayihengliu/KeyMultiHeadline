...
class BertSentenceSummarizerCopyRL(BaseModel):
    """
    Based on BertSentenceSummarizerCopy.
    Add RL loss.
    """

    def __init__(self, bert_config, batcher, hps):
        super(BertSentenceSummarizerCopyRL, self).__init__(hps, bert_config, batcher)
